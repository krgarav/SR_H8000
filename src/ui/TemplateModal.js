...
const TemplateModal = (props) => {
    ...
    const [windowNgOption, setWindowNgOption] = useState({ id: "0x00000001", name: "SKDV_ACTION_SELECT(0x00000001)", showName: "Paper ejection to select stacker" });
    ...
    const [idPresent, setIdPresent] = useState({ id: "not present", name: "Not Present" });
    ...
    const createTemplateHandler = async () => {
        ...
        if (!name || !numberOfLines || !numberOfFrontSideColumn || !selectedBubble || !idPresent || !reject || !face || barCount.length === 0 || difference.length == 0 || !direction || face.length === 0) {
            settoggle((prevData) => ({
                ...prevData,
                ...
                windowNgOption: Object.values(windowNgOption).length == 0 ? true : prevData.windowNgOption
            }));
            if (!name) {
                                        ...
                                        <Tab.Content>
                                            ...
                                            <div className="col-md-10">
                                                ...
                                                <Row className="mb-3">
                                                    ...
                                                    <div className={idPresent.id === "not present" ? "col-md-10" : "col-md-4"}>
                                                        <Select
                                                            styles={{
                                                ...
                                                {idPresent.id !== "not present" && <Row className="mb-2">
                                                    <label
                                                        htmlFor="example-text-input"
                                                        className="col-md-2 col-form-label"
                                                        style={{ fontSize: ".9rem" }}
